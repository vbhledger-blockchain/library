...
import (
	...
	"errors"
	"fmt"
	"github.com/vbhledger-blockchain/library/gm/internal/cpu"
...
const (
	...
	SM2WithSM3 SignatureScheme = 0x0701
)
...
type Config struct {
	...
	PreferServerCipherSuites bool // 首选服务器密码套件

	// SessionTicketsDisabled may be set to true to disable session ticket and
	// PSK (resumption) support. Note that on clients, session ticket support is
	// also disabled if ClientSessionCache is nil.
	SessionTicketsDisabled bool  // 是否禁用sesion
